...
Thanks for using `eslint-plugin-tsconfig`.
...
2. Search existing issues:
   - <https://github.com/Nick2bad4u/eslint-plugin-tsconfig/issues>
3. Open a new issue if needed:
   - <https://github.com/Nick2bad4u/eslint-plugin-tsconfig/issues/new>
...
- TypeScript version
- ESLint version
- `eslint-plugin-tsconfig` version
