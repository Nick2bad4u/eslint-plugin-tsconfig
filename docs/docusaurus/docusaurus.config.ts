            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            className: "nb-preset-recommended",
                            label: "🟡 Recommended",
                        ...
                        {
                            className: "nb-preset-emit-config",
                            label: "📤 emit-config",
                            to: "/docs/rules/presets/emit-config",
                        },
                        {
                            className: "nb-preset-include-hygiene",
                            label: "🧹 include-hygiene",
                            to: "/docs/rules/presets/include-hygiene",
                        },
                        {
                            className: "nb-preset-lib-target",
                            label: "🎯 lib-target",
                            to: "/docs/rules/presets/lib-target",
                        },
                        {
                            className: "nb-preset-module-resolution",
                            label: "📦 module-resolution",
                            to: "/docs/rules/presets/module-resolution",
                        },
                        {
                            className: "nb-preset-project-references",
                            label: "🔗 project-references",
                            to: "/docs/rules/presets/project-references",
                        },
                        {
                            className: "nb-preset-strict-mode",
                            label: "🔒 strict-mode",
                            to: "/docs/rules/presets/strict-mode",
                        },
                    ],
                },
                {
