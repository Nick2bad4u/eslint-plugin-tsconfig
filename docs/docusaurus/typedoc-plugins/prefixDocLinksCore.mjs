...
/**
 * Prefixes bare intra-doc Markdown file links with `./`. This function is
 * designed to operate on TypeDoc's markdown renderer output, where links are
 * mostly simple inline links. It intentionally avoids parsing inside fenced
